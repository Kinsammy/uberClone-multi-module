...
import io.samtech.configuration.annotation.Modular;
import io.samtech.configuration.annotation.context.FeaturePrivilegeClaim;
import io.samtech.configuration.annotation.context.MessageResourceClaim;
